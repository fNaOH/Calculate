    ...
    <body>
        <table class='main'>
            ...
            <tr>
                ...
                <td id='content1' >
                    <form action="ex2" method="post"  style="margin:auto; text-align: center">
                        Nhap a <input type="text" name="txta" value="${a}"/><br>
                        Nhap b <input type="text" name="txtb" value="${b}"/><br>
                        Nhap c <input type="text" name="txtc" value="${c}"/><br>
                        Ket qua <input  name="ketqua" readonly  value="${display}" />
                        <div><input type="radio" name="radio" value="max"  /><label>tim so lon nhat</label></div>
                        <div><input type="radio" name="radio" value="min"/><label>tim so nho nhat</label></div>
